...
const required = [
  ...
  ['Foundation metadata 07.5.7', /FOUNDATION\s*=\s*["']07\.5\.7["']/],
  ['Revision metadata evidence-model-v1', /REVISION\s*=\s*["']evidence-model-v1["']/],
];
...
console.log('[QAgent Catalog] D1, Queue consumer, recovery cron and 07.5.7 release metadata verified.');
