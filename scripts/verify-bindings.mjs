...
const required = [
  ...
  ['Foundation metadata 07.5.5', /FOUNDATION\s*=\s*["']07\.5\.5["']/],
  ['Revision metadata classification-engine-v1', /REVISION\s*=\s*["']classification-engine-v1["']/],
];
...
console.log('[QAgent Catalog] D1, Queue consumer, recovery cron and 07.5.5 release metadata verified.');
