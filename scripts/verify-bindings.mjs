...
const required = [
  ...
  ['Foundation metadata 07.5.6', /FOUNDATION\s*=\s*["']07\.5\.6["']/],
  ['Revision metadata schema-versioning-v1', /REVISION\s*=\s*["']schema-versioning-v1["']/],
];
...
console.log('[QAgent Catalog] D1, Queue consumer, recovery cron and 07.5.6 release metadata verified.');
