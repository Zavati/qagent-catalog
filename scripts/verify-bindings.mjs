...
const required = [
  ...
  ['Foundation metadata 07.5.10', /FOUNDATION\s*=\s*["']07\.5\.10["']/],
  ['Revision metadata catalog-lifecycle-v1', /REVISION\s*=\s*["']catalog-lifecycle-v1["']/],
];
...
console.log('[QAgent Catalog] D1, Queue consumer, recovery cron and 07.5.10 release metadata verified.');
